...
<div 
  class={isHovered ? "statehovered" : "statedefault"} 
  ...
  role="button"
  tabindex="0"
  aria-label={`View grid: ${gridName} by ${author}`}
>
...
<style>
  ...
  .card_left:hover, .card_center:hover, .card_right:hover {
    z-index: 10;
  }
  ...
  .statehovered {
    ...
    border-radius: 15px;
    outline: 5px rgba(255, 255, 255, 0.29) solid;
    outline-offset: -5px;
    justify-content: center;
    align-items: center;
    gap: 10px;
